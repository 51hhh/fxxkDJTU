...
请到发布页面下载对应的安装包：[Release page](https://github.com/51hhh/fxxkDJTU/releases)<br>
Go to the [Release page](https://github.com/51hhh/fxxkDJTU/releases) to download the corresponding installation package.
